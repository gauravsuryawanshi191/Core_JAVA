...
public class CustomerValidations {
	public static String checkDublicate(String email, Map<String, Customer> custMap) throws DublicateEntryException {
		if (custMap.containsKey(email))
			throw new DublicateEntryException("Email already exists!\n" + "Try another Email");
		return email;
	}

	public static LocalDate validateAndParseDOB(String dateOfBirth)
			throws DateOfBirthException, DateTimeParseException {
	...
	public static Customer superValidater(String firstName, String lastName, String emailId, String password,
			int registrationAmount, String dateOfBirth, String servicePlan)
